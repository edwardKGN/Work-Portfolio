...
class solvency_gen(fundamentalsAnalysis.financialData_main):
    ...
    def interestCoverageRatio(self, year):
        ...
        totInterestPaid = self.getInputElement("Total Interest Paid", year)
        
        if totInterestPaid == 0:
            print("ERROR - Interest Coverage Ratio: Total Interest Paid is zero")
            return 0
        
        return EBITDA/totInterestPaid
    ...
    def averageInterestRate(self, year):
        ...
        return totInterestPaid/totDebt