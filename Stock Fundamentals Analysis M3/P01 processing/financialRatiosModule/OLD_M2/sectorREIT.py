...
class financialData_REIT(FR_Valuation_gen.valuation_gen, FR_Profitability_gen.profitability_gen, FR_Efficiency_gen.efficiency_gen, FR_Liquidity_gen.liquidity_gen, FR_Solvency_gen.solvency_gen, FR_sub_dividendPaying.dividendPaying, FR_sub_haveSales.haveSales, FR_sub_inventoryHolding.inventoryHolding, financialRatios.financialData_main): # Method Resolution Order (MRO) second layer that inherit from first layer must be declared prior the first layer of inheritence. 
    ...
    def analyze_REIT(self):
        print("Analyze REIT's Financial Ratios")
